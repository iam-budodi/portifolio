  ...
  render() {
    ...
    return (
      <div id="projects" className="my-2 space-y-8 p-6 lg:px-12 lg:py-8">
        ...
        <div className="lg:w-8/12 space-y-2 lg:mx-auto">
          ...
          <div className="flex-1 lg:space-x-12  overflow-y-auto">
            ...
            >
              <div className="p-4">
                <div className="w-11/12 m-auto transform motion-safe:hover:scale-100 group hover:border-transparent hover:shadow-inner rounded overflow-hidden shadow-2xl">
                  <Image
                  ...
                  <div className="px-6 py-4">
                    <div className="font-semibold text-indigo-500 text-xl mb-2">Weather App</div>
              ...
              <div className="p-4">
                <div className="w-11/12 m-auto transform motion-safe:hover:scale-100 rounded overflow-hidden shadow-2xl">
                  ...
                  />
                  <div className="px-6 py-4">
                    <div className="font-semibold text-indigo-500 text-xl mb-2">My Portifolio Site</div>
                    <p className="text-gray-700 text-base">
