      ...
      <form action="#" method="POST">
        <div className="sm:overflow-hidden sm:rounded-md">
          ...
          <div className="py-5 bg-white space-y-8 sm:p-6">
            <div className="space-x-12 lg:w-8/12 lg:mx-auto">
              <div className="col-span-6 sm:col-span-3 lg:inline-block lg:w-6/12">
              ...
              <div className="col-span-6 sm:col-span-4 lg:inline-block lg:w-6/12">
            ...
            <div className="px-4 py-6 bg-gray-50 text-right sm:px-6">
              <button
                type="submit"
                className="inline-flex justify-center py-2 px-8 border border-transparent shadow-sm text-md font-medium rounded-md text-white bg-yellow-400 hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 lg:w-3/12 lg:mx-auto"
              >
                Send
              </button>
            </div>
