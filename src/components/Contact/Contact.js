          ...
          <div className="py-2 bg-white space-y-8 lg:space-y-4">
            ...
            <div className="p-4 bg-gray-50 sm:px-6">
              <div className="lg:w-3/12 lg:mx-auto">
                <button
                  type="submit"
                  className="py-2 px-8 border border-transparent shadow-sm text-md font-medium rounded-md text-white bg-yellow-500 hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 w-full"
                >
                  Send
                </button>
              </div>
