...
const Hero = () => (
  <section className="relative">
    <div
      className="min-h-screen bg-fixed overflow-auto bg-cover bg-center bg-no-repeat bg-opacity-0 text-white"
      style={{ backgroundImage: 'url(/images/background-1.jpg)' }}
    >
      <div className="container">
        <div className="grid-cols-12 lg:grid-cols-7 md:grid-cols-12 items-center h-3/6 m-auto absolute top-0 right-0 bottom-0 left-0">
